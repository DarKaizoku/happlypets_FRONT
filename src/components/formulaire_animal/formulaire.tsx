                  ...
                  <div className="modal-body shadow bg-warning">
                    <ul>
                      <li>
                        ...
                        <a href="https://postimages.org/fr/" target="_blank">
                          postimages
                        </a>
                      </li>
                      <li>
                        Selectionnez votre image avec le bouton "Choisissez
                        votre image"
                      </li>
                      <li>
                        Une fois validée, copiez le "lien direct" et le coller
                        ici :
                      </li>
                    </ul>
                    <form>
          ...
          <div className="col-12 mt-3">
            <div className="form-check">
              ...
              <label className="form-check-label" htmlFor="invalidCheck">
                J'accèpte que les données de mon animal soit publique sur le
                site
              </label>
            </div>
          </div>
